...
!(function (t, e) {
  ...
  class U extends z {
    ...
    close(t) {
      const e = t ? this._viewRootElement(t) : this._element,
  ...
  class J extends z {
    constructor(t, e) {
      super(t),
        ...
        (this.touchStartX = 0),
        (this.touchDeltaX = 0),
        (this._config = this._viewConfig(e)),
    ...
    to(t) {
      ...
      const e = this._viewItemIndex(this._activeElement);
    ...
    _viewItemByOrder(t, e) {
      const s = t === X,
        i = t === Y,
        n = this._viewItemIndex(e),
    ...
    _triggerSlideEvent(t, e) {
      const s = this._viewItemIndex(t),
        n = this._viewItemIndex(
    ...
    _slide(t, e) {
      const s = this._directionToOrder(t),
        ...
        o = this._viewItemIndex(n),
        r = e || this._viewItemByOrder(s, n),
        a = this._viewItemIndex(r),
  ...
  class st extends z {
    constructor(t, e) {
      ...
      (this._parent = this._config.parent ? this._viewParent() : null),
        this._config.parent ||
      ...
      i.find(s).forEach((t) => {
        ...
        s
          ? (null === s._parent &&
              ...
              ((s._config.parent = e.parent), (s._parent = s._viewParent())),
            (i = "toggle"))
          : (i = e),
  ...
  class ut extends z {
    constructor(t, e) {
      super(t),
        (this._popper = null),
        (this._config = this._viewConfig(e)),
        (this._menu = this._viewMenuElement()),
    ...
    show() {
      ...
      if (!$.trigger(this._element, "show.bs.dropdown", e).defaultPrevented) {
        if (this._inNavbar) K.setDataAttribute(this._menu, "popper", "none");
          ...
          const i = this._viewPopperConfig(),
            n = i.modifiers.find(
    ...
    _viewPopperConfig() {
      const t = {
        placement: this._viewPlacement(),
        modifiers: [
          {
            name: "preventOverflow",
            options: { boundary: this._config.boundary },
          },
          { name: "offset", options: { offset: this._viewOffset() } },
        ],
      };
      return (
  ...
  class wt {
    constructor(t) {
      (this._config = this._viewConfig(t)),
        (this._isAppended = !1),
        (this._element = null);
    }
    show(t) {
      this._config.isVisible
        ? (this._append(),
          this._config.isAnimated && b(this._viewElement()),
          this._viewElement().classList.add("show"),
    ...
    hide(t) {
      this._config.isVisible
        ? (this._viewElement().classList.remove("show"),
          this._emulateAnimation(() => {
            this.dispose(), E(t);
          }))
        : E(t);
    ...
    _append() {
      this._isAppended ||
        (this._config.rootElement.appendChild(this._viewElement()),
        $.on(this._viewElement(), "mousedown.bs.backdrop", () => {
    ...
    dispose() {
      this._isAppended &&
        ...
        this._viewElement().parentNode.removeChild(this._element),
        (this._isAppended = !1));
    }
    _emulateAnimation(t) {
      if (!this._config.isAnimated) return void E(t);
      const e = l(this._viewElement());
      $.one(this._viewElement(), "transitionend", () => E(t)),
        u(this._viewElement(), e);
    }
  }
  ...
  class Bt extends z {
    ...
    _handlePopperPlacementChange(t) {
      ...
      e &&
        ...
        this._cleanTipClass(),
        this._addAttachmentClass(this._viewAttachment(e.placement)));
    }
    static jQueryInterface(t) {
      return this.each(function () {
  ...
  class Ft extends Bt {
    ...
    isWithContent() {
      return this.getTitle() || this._viewContent();
    }
    setContent() {
      const t = this.getTipElement();
      this.setElementContent(i.findOne(".popover-header", t), this.getTitle());
      let e = this._viewContent();
  ...
  class Vt extends z {
    ...
    refresh() {
      const t =
        ...
        s = "position" === e ? this._viewScrollTop() : 0;
      (this._offsets = []),
        (this._targets = []),
        (this._scrollHeight = this._viewScrollHeight()),
        i
          .find(this._selector)
          .map((t) => {
            const n = r(t),
    ...
    _process() {
      const t = this._viewScrollTop() + this._config.offset,
        e = this._viewScrollHeight(),
        s = this._config.offset + e - this._viewOffsetHeight();
