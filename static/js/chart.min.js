...
!(function (t, e) {
  ...
  H.extend(nt.prototype, {
    ...
    _viewValueScaleId: function () {
      return this.getMeta().yAxisID;
    },
    _viewIndexScaleId: function () {
      return this.getMeta().xAxisID;
    },
    _viewValueScale: function () {
      return this.getScaleForId(this._viewValueScaleId());
    },
    _viewIndexScale: function () {
      return this.getScaleForId(this._viewIndexScaleId());
    },
    reset: function () {
      this._update(!0);
    },
  ...
  var Tt = it.extend({
      ...
      initialize: function () {
        ...
        it.prototype.initialize.apply(n, arguments),
          ...
          Pt(
            "bar chart",
            n._viewValueScale().options.minBarLength,
      ...
      _viewStacks: function (t) {
        var e,
          n,
          i = this._viewIndexScale(),
          a = i._viewMatchingVisibleMetas(this._type),
          r = i.options.stacked,
          o = a.length,
          s = [];
        for (
      ...
      getStackCount: function () {
        return this._viewStacks().length;
      },
      getStackIndex: function (t, e) {
        var n = this._viewStacks(t),
      ...
      calculateBarValuePixels: function (t, e, n) {
        var i,
          ...
          u,
          d = this.chart,
          h = this._viewValueScale(),
          c = h.isHorizontal(),
          f = d.data.datasets,
          g = h._viewMatchingVisibleMetas(this._type),
      ...
      _resolveDataElementOptions: function () {
        var t = this,
          ...
          n = t._viewIndexScale().options,
          i = t._viewValueScale().options;
        return (
  ...
  var Bt = it.extend({
      ...
      for (
        o.borderWidth = r.getMaxBorderWidth(),
          ...
          o.radiusLength =
            ...
            (r._viewVisibleDatasetWeightTotal() || 1),
          o.offsetX = h * o.outerRadius,
          o.offsetY = c * o.outerRadius,
          f.total = r.calculateTotal(),
          r.outerRadius =
            o.outerRadius - o.radiusLength * r._viewRingWeightOffset(r.index),
    ...
    _viewRingWeightOffset: function (t) {
      for (var e = 0, n = 0; n < t; ++n)
        this.chart.isDatasetVisible(n) && (e += this._viewRingWeight(n));
      return e;
    },
    _viewRingWeight: function (t) {
      return Math.max(Lt(this.chart.data.datasets[t].weight, 1), 0);
    },
    _viewVisibleDatasetWeightTotal: function () {
      return this._viewRingWeightOffset(this.chart.data.datasets.length);
    },
  });
  ...
  var Yt = it.extend({
      ...
      calculatePointY: function (t, e, n) {
        ...
        if (h.options.stacked) {
          for (
            s = +h.getRightValue(t),
              u = (l = d._viewSortedVisibleDatasetMetas()).length,
              i = 0;
            i < u && (r = l[i]).index !== n;
            ++i
          )
  ...
  function te(t, e) {
    var n,
      ...
      o,
      s,
      l = t._viewSortedVisibleDatasetMetas();
  ...
  function ae(t, e, n) {
    ...
    var a = ie(n.axis),
      ...
      o = [];
    return r.length
      ? (t._viewSortedVisibleDatasetMetas().forEach(function (t) {
  ...
  H.extend(tn.prototype, {
    ...
    _viewSortedDatasetMetas: function (t) {
      var e,
        n,
        i = [];
    ...
    _viewSortedVisibleDatasetMetas: function () {
      return this._viewSortedDatasetMetas(!0);
    },
    drawDatasets: function (t) {
      var e, n;
      if (!1 !== Le.notify(this, "beforeDatasetsDraw", [t])) {
        for (
          n = (e = this._viewSortedVisibleDatasetMetas()).length - 1;
          n >= 0;
          --n
        )
  ...
  var xn = K.extend({
    ...
    calculateTickRotation: function () {
      ...
      !s._isVisible() || !u.display || h >= c || d <= 1 || !s.isHorizontal()
        ? (s.labelRotation = h)
        : ((e = (t = s._viewLabelSizes()).widest.width),
    ...
    _viewMatchingVisibleMetas: function (t) {
      var e = this,
        n = e.isHorizontal();
      return e.chart._viewSortedVisibleDatasetMetas().filter(function (i) {
        return (
  ...
  var yn = xn,
    ...
    kn = yn.extend({
      ...
      getLabelForIndex: function (t, e) {
        var n = this.chart;
        return n.getDatasetMeta(e).controller._viewValueScaleId() === this.id
  ...
  var Tn = Cn.extend({
      ...
      getLabelForIndex: function (t, e) {
        return this._viewScaleLabel(this.chart.data.datasets[e].data[t]);
      },
  ...
  var zn = yn.extend({
      ...
      _viewFirstTickValue: function (t) {
      ...
      _configure: function () {
        ...
        yn.prototype._configure.call(t),
          0 === e &&
            ((e = t._viewFirstTickValue(t.minNotZero)),
            (n =
  ...
  var hi = yn.extend({
      ...
      getLabelWidth: function (t) {
        return this._viewLabelSize(t).w;
      },
    ...
    legend: {
      ...
      labels: {
        ...
        generateLabels: function (t) {
          ...
          return t._viewSortedDatasetMetas().map(function (n) {
  ...
  var Ai = K.extend({
    ...
    _viewLegendItemAt: function (t, e) {
      var n,
        i,
        a,
        r = this;
  ...
  (function () {
    ...
    (H.where = function (t, e) {
      ...
      (H._viewParentNode = function (t) {
        var e = t.parentNode;
        return e && "[object ShadowRoot]" === e.toString() && (e = e.host), e;
      }),
      (H.getMaximumWidth = function (t) {
        var e = H._viewParentNode(t);
